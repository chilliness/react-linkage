...
import { LinkageBase, LinkageTime, LinkageDate, LinkageAddr } from '@/components';
import './index.scss';
...
export default class index extends Component {
  ...
  handleConfirm = (e, type, divide = '-') => {
    let { val, bool } = e;
    if (bool) {
      this.setState({
        [type]: val.join(divide),
        [`${type}Flag`]: false
      });
    }
  };
  ...
  render() {
    let {
      state: { base, baseFlag, time, timeFlag, date, dateFlag, addr, addrFlag },
      handleConfirm,
      handleCancel,
      handleToggle
    } = this;
    ...
    return (
      <div className="home-wrap">
        ...
        <div className="input-box">
          <input className="input" type="text" value={base} onChange={() => {}} />
          <div className="btn" onClick={() => handleToggle('baseFlag', true)}>
            自定义选择
          </div>
        </div>
        ...
        <div className="input-box">
          ...
          <div className="btn" onClick={() => handleToggle('timeFlag', true)}>
            时间选择
          </div>
        </div>
        ...
        <div className="input-box">
          ...
          <div className="btn" onClick={() => handleToggle('dateFlag', true)}>
            日期选择
          </div>
        </div>
        ...
        <div className="input-box">
          ...
          <div className="btn" onClick={() => handleToggle('addrFlag', true)}>
            地址选择
          </div>
        </div>
